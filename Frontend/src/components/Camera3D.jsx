...
const Camera3D = () => {
  ...
  return (
    <div className="relative h-[30rem] pt-24 flex justify-center items-center z-10 mb-8">
      {/* Background video */}
      <video
        autoPlay
        loop
      ...
      >
        ...
        <div className="absolute bottom-5 left-1/2 transform -translate-x-1/2 text-white text-center z-20">
          <h1 className="text-xl font-bold">3D Camera Showcase</h1>
          <p className="text-m">Explore the model by rotating and panning!</p>
        </div>
      </div>

  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 flex items-center justify-center overflow-hidden bg-gradient-to-b from-black via-gray-950 to-black">
        <motion.div
          style={{ y, opacity }}
          className="relative w-full max-w-7xl mx-auto px-4 py-8 sm:py-16 md:py-16"
        >
          <motion.div
          ...
          <div className="relative perspective-2000">
            <motion.div
              ...
              className="relative mx-auto w-full h-[70vh] sm:h-[70vh] md:h-[80vh] lg:h-[100vh] overflow-hidden rounded-2xl shadow-2xl"
            >
              <motion.img
                src={camera}
                alt="Professional Camera"
                className="w-full h-auto max-w-[400px] sm:max-w-[500px] md:max-w-[800px] object-contain rounded-2xl mx-auto shadow-2xl"
              />
              ...
              {features.map((feature, index) => (
                <motion.div
                  ...
                  style={{
                    ...
                    z: useSpring(useTransform(scrollYProgress, [0, 1], [0, 50]), springConfig),
                    ...feature.position,
                  }}
      ...
      {/* Third Section - Lens */}
      <div className="sticky top-0 h-screen flex items-center justify-center bg-black/90 mb-[5rem]">
        <motion.div
          style={{
          ...
          <div className="relative h-screen overflow-hidden">
            ...
            >
              {[camera4, camera5, camera6, camera7, camera4, camera5, camera6, camera7].map((url, index) => (
                <div
                  key={index}
                  className="relative flex-none w-[200px] sm:w-[300px] md:w-[400px] h-[300px] sm:h-[500px] md:h-[600px] rounded-2xl overflow-hidden shadow-lg"
                >
                  <img
                    src={url}
                    alt={`Lens ${index + 1}`}
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center text-white z-10 px-4">
              ...
              <motion.p
                ...
                className="text-xs sm:text-xs md:text-lg text-gray-300 whitespace-nowrap mt-2 sm:mt-4"
              >
